...
namespace ConsoleAppTestАssembler
{
    ...
    {
        public TestObject(string text, int a, int b)
        {
            this.Text = text;
            this.A = a;
            this.B = b;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            TestObject testObject = new TestObject("Text", 2, 2);
            ...
            Console.WriteLine("Исходный массив сформирован нажмите. Нажмитие Enter для выполнения сортировки на ассемблере");
            Console.ReadLine();
